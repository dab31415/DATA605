...
Accounting for the prevalence rate of .001, we estimate 100 people per 100,000 are positive.

| per 100,000    | Is Positive | Is Negative | Total   |
|----------------|-------------|-------------|---------|
| Tests Positive |          96 |       1,998 |   2,094 |
| Tests Negative |           4 |      97,902 |  97,906 |
| Total          |         100 |      99,900 | 100,000 |

The probability that an individual is positive, given that they test positive = 96/2094 = 4.58%
...
The 1,000 tests cost \$100 million and the 100 positive cases cost \$10 million, for a total of \$110 million.
...
If we assume a work day is 8 hours, we expect to receive 80 patients, but can only service 72 with the three providers on staff. This gives a utilization rate of $80/72$. The practice needs to hire an additional provider or reduce the number of hours that they except patients.
...
The expected value is 1 failure in 1000 hours.
...
The expected failure time and the standard deviation are both the same at 10 years.
